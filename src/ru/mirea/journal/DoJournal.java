...
import static ru.mirea.journal.ActionDoc.*;
import static ru.mirea.journal.ActionUser.*;
...
public class DoJournal implements Journal {
    ...
    public class User {
        ...
        User(int UserId, ActionUser Act) {
            a = Act;
            id = UserId;
        } /* The constructor */
        ...
        public class Doc {
            ...
            Doc(String DocId, ActionDoc Act, String Filename) {
                String di = new String(DocId);
                ActionDoc a = Act;
                String fname = new String(Filename);
            /*String newfield = new String (NewFieldValue);*/
